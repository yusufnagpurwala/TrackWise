...
if(isset($_POST['submit'])) {
    ...
    require('connect.php');
    $stmt = $db->prepare("INSERT INTO expenses (user_id, description, type, category, amount, date, notes) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssdss", $user_id, $desc, $type, $category, $amount, $date, $notes);
...
<div class="container mt-4">
    <h1 class="text-center text-primary-emphasis">Add Expense</h1>
        ...
        <div class="col-12 col-lg-6 p-4 border shadow rounded-4 w-full">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="desc" placeholder="eg. Coffee with friends..." class="form-control" required>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        <label class="form-label">
                        ...
                        <select name="type" class="selectpicker form-select" id="inputGroupSelect01">
                            <option value="in" selected>Cash In</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="amt" placeholder="Enter Amount" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">
                    <i class="bi bi-file-earmark text-primary-emphasis"></i>
                    <span class="fw-semibold"> Notes(Optional) </span></label>
                    <textarea type="text" name="notes" placeholder="Add any additional information..." class="form-control" style="height: 100px"></textarea>
                </div>
                <div class="d-flex d-grid gap-2 mb-3">
                    <button type="submit" name="submit" class="btn btn-solid col-8"><i class="bi bi-plus-circle"></i> Add Entry</button>
                    <button type="reset" class="btn btn-outline-primary col-4"><i class="bi bi-arrow-left"></i> Cancel</button>
                </div>
            </form>
        </div>
    </div>
